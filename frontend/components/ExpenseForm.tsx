        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-5 space-y-4 overflow-y-auto no-scrollbar flex-1">
            ...
            <div className="grid grid-cols-3 sm:flex sm:flex-wrap gap-2">
              {COMMON_SHORTCUTS.map(s => (
                <button
                  ...
                  className={`flex items-center justify-center sm:justify-start gap-1.5 px-3 py-2.5 sm:px-3 sm:py-2 rounded-xl border transition-all duration-200 active:scale-95 cursor-pointer text-xs font-semibold ${description === s.label ? 'bg-emerald-500 border-emerald-500 text-gray-950 shadow-[0_2px_10px_rgba(16,185,129,0.2)]' : 'bg-gray-950/60 border-white/[0.04] text-gray-400 hover:border-white/[0.1] hover:bg-gray-950'}`}
                >
                  {s.icon}
                  <span>{s.label}</span>
                </button>
          ...
          <div className="flex bg-gray-950/80 p-1 rounded-xl border border-white/[0.04] gap-1">
            <button 
              ...
              className={`flex-1 py-3 text-[11px] font-bold uppercase tracking-wider rounded-lg transition-all duration-200 cursor-pointer ${type === 'FIXED' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 shadow-[0_0_12px_rgba(16,185,129,0.1)]' : 'text-gray-500 hover:text-gray-400'}`}
            >
              Fixo
            </button>
            <button 
              ...
              className={`flex-1 py-3 text-[11px] font-bold uppercase tracking-wider rounded-lg transition-all duration-200 cursor-pointer ${type === 'INSTALLMENT' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 shadow-[0_0_12px_rgba(16,185,129,0.1)]' : 'text-gray-500 hover:text-gray-400'}`}
            >
              Parcelado
            </button>
            <button 
              ...
              className={`flex-1 py-3 text-[11px] font-bold uppercase tracking-wider rounded-lg transition-all duration-200 cursor-pointer ${type === 'ONCE' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 shadow-[0_0_12px_rgba(16,185,129,0.1)]' : 'text-gray-500 hover:text-gray-400'}`}
            >
              Único
            </button>
          </div>
          ...
          {/* Form Actions */}
          <div className="pt-3 flex gap-3 border-t border-white/[0.04] shrink-0">
            <button 
              type="button" 
              onClick={onClose} 
