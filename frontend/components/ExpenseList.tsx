                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <p className={`text-base sm:text-md font-bold tracking-tight shrink-0 ${progress?.isFinished ? 'text-emerald-400/80' : 'text-white'}`}>
                        {formatCurrency(expense.value)}
                      </p>
                    </div>

                    {/* Metadata tags */}
                    <div className="flex flex-wrap gap-2 sm:gap-2 mt-3 sm:mt-3">
